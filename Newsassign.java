...
public class Newsassign
{
    ...
    {
        News s1=new News(1,"Bhuvana","Sreeja","budget");
        News s2=new News(2,"Sreeja","Akhila","Excellent");
        News s3=new News(3,"Mounika","Bhuvana","budget");
        News s4=new News(4,"Akhila","Mounika","Super");
