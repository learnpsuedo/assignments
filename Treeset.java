package com.company;
    ...
    class TreesetExample {
        public static void main(String[] args) {
            ...
            Employee1 t1 = new Employee1(1, "b", "B", 10000);
            Employee1 t2 = new Employee1(2, "i", "c", 20000);
            Employee1 t3 = new Employee1(3, "c", "a", 30000);
            Employee1 t4 = new Employee1(4, "s", "j", 40000);
            ...
            System.out.println("choose 1 for id  choose 2 for name choose 3 for department choose 4 for salary");
            ...
            switch (choose) {
                case 1:
                    ...
                    break;
                case 2:
                    TreeSet<Employee1> s2 = new TreeSet<>(new Sortbyname());
                    s2.add(t1);
                    s2.add(t2);
                    s2.add(t3);
                    s2.add(t4);
                    ...
                    break;
                case 3:
                    TreeSet<Employee1> s3 = new TreeSet<Employee1>(new Sortbydepartment());
                    s3.add(t1);
                    s3.add(t2);
                    s3.add(t3);
                    s3.add(t4);
                    ...
                    break;
                case 4:
                    TreeSet<Employee1> s4 = new TreeSet<Employee1>(new Sortbysalary());
                    s4.add(t1);
                    s4.add(t2);
                    s4.add(t3);
                    s4.add(t4);
